  ...
  return (
    <aside className="w-72 bg-[#09090b] border-r border-zinc-800/50 flex flex-col h-full z-40">
              ...
              {areas.slice(0, 2).map((area) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${
                    activeArea === area 
                      ? 'bg-zinc-800/50 text-indigo-400 ring-1 ring-zinc-700' 
      ...
      <div className="mt-auto p-6 border-t border-zinc-800/50">
        <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-zinc-500 hover:text-zinc-300 hover:bg-zinc-800/30 transition-all">
